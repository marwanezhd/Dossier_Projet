...
<script>
	...
	// [plan, app, git, archi]
	function switchMod(targetedMod) {
		selectMod = targetedMod;
		console.log(selectMod); // dbg
	}
	
	document.title = "visual flow";
</script>

	{#if selectMod == undefined}
			...
			<div class="mod_card">
				<div>
					...
					<div class="select_card">
						Application
						<br /><br />
						<Button color="light" on:click={() => switchMod("app")}>
				...
				<div>
					<div class="select_card">
						Github
						<br /><br />
						<Button color="light" on:click={() => switchMod("git")}>
					...
					<div class="select_card">
						Architecture
						<br /><br />
						<Button color="light" on:click={() => switchMod("archi")}>
